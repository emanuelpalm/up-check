...
/**
 * Various {@link View} utilities.
 */
public class Views {
    private static final Map<Class<?>, Class<? extends WindowView>> mapViewToWindowView;

    static {
        final Reflections reflections = new Reflections(Views.class.getPackage().getName());
    ...
    /**
     * Creates concrete implementation of provided {@link View} interface class.
     *
     ...
     */
    public static View newInstance(final Class<? extends View> viewClass) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
